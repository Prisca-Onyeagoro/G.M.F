        ...
        <div className="grid grid-cols-5 gap-2">
          <div className="col-span-2">
            <div className="h-full w-full relative mr-4">
                <Image src={img} alt={title} layout="fill" className="object-cover ring-[2px] ring-slate-900 rounded-lg" />
            </div>
          </div>
          <div className="col-span-3 flex flex-col gap-1">
            <h3 className="font-bold text-gray-900">{title}</h3>
            <p className="text-gray-500"><span className="text-green-500">{percent}%</span> <span className="text-xs">in 5 months</span></p>
